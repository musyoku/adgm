...
conf.decoder_yz_x_apply_batchnorm = False
conf.decoder_yz_x_apply_batchnorm_to_input = False

conf.decoder_xyz_a_hidden_units = [500, 500]
conf.decoder_xyz_a_activation_function = "elu"
conf.decoder_xyz_a_apply_dropout = False
conf.decoder_xyz_aapply_batchnorm = False
conf.decoder_xyz_a_apply_batchnorm_to_input = False
