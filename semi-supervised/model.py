...
conf.encoder_x_a_activation_function = "leaky_relu"
...
conf.encoder_xy_z_activation_function = "leaky_relu"
...
conf.encoder_ax_y_activation_function = "leaky_relu"
...
conf.decoder_hidden_units = [500, 500]
conf.decoder_activation_function = "leaky_relu"
