...
conf.decoder_yz_a_hidden_units = [500, 500]
conf.decoder_yz_a_activation_function = "elu"
conf.decoder_yz_a_apply_dropout = False
conf.decoder_yz_a_apply_batchnorm = True
conf.decoder_yz_a_apply_batchnorm_to_input = True
